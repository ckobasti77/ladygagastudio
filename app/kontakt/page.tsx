...
const responseWindows = [
  "Upiti do 15 h: odgovor istog dana",
  "Hitni termini: prioritetna obrada",
  "Online podrška: 7 dana u nedelji",
] as const;
...
const contactNodes = [
  ...
  },
  {
    ...
    detail: "Pisani plan tretmana i preporuka proizvoda u roku od 24 h.",
    Icon: Mail,
  ...
  },
  {
    ...
    detail: "Parking i gradski prevoz nalaze se u blizini studija.",
    Icon: MapPin,
...
export default function ContactPage() {
  ...
  const submit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    if (!legalAccepted) {
      setStatus("error");
      setStatusMessage("Potrebno je da prihvatite politiku privatnosti i pravila korišćenja.");
      return;
    }
    ...
    try {
      ...
      setStatus("error");
      setStatusMessage("Slanje nije uspelo. Pokušajte ponovo za nekoliko sekundi.");
    }
  };
    ...
    <div className="contact-page">
      <section className="contact-hero">
        ...
        <div className="contact-hero-inner">
          ...
          <h1 className="contact-title">Pošaljite poruku i dobićete jasan plan za vašu kosu.</h1>

          <p className="contact-lead">
            Ostavite upit za tretman, koloraciju, keratin ili frizuru. Dobićete predlog usluge i preporuku proizvoda
          ...
          <div className="contact-services-layout">
            <div className="contact-services-copy">
              <div className="contact-services-header">
                <p className="contact-eyebrow">Šta možete da zakažete</p>
                <h2>Usluge i tretmani koje klijentkinje najčešće biraju.</h2>
              </div>

              <p className="contact-services-intro">
                Svaki termin planiramo prema trenutnom stanju kose, prethodnim hemijskim procesima i rezultatu koji
              ...
              <div className="contact-services-panels">
                ...
                <article className="contact-services-panel">
                  <div className="contact-services-panel-head">
                    <p className="contact-services-panel-kicker">Profesionalna nega</p>
            ...
            <figure className="contact-services-media">
              ...
              <figcaption className="contact-services-media-caption">
                Mirna atmosfera, precizan pregled i preporuka za kućnu negu.
              </figcaption>
            </figure>
          </div>
        </div>
      ...
      <section id="contact-form-section" className="contact-map-form">
        <article className="contact-map-card">
          <div className="contact-map-inner">
            ...
            <p>
              Ako dolazite prvi put, napišite u poruci da ste nova klijentkinja i dobićete smernice za najbrži dolazak.
            </p>
            <iframe
        ...
        <form onSubmit={submit} className="contact-form-card">
          <div className="contact-form-inner">
            <div className="contact-form-header">
              ...
              <p>U poruci navedite trenutno stanje kose i rezultat koji želite da postignete.</p>
            </div>
            ...
            <label className="contact-form-consent" htmlFor="contact-legal-consent">
              ...
              <span>
                ...
                <Link href="/politika-privatnosti">Politiku privatnosti</Link> i{" "}
            ...
            <p className="contact-form-footer">
              Za brzu kupovinu preporučenih proizvoda otvorite <Link href="/proizvodi">stranicu proizvoda</Link>.
            </p>
          </div>
        </form>
      </section>
