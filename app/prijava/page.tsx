...
function AuthPageContent() {
  ...
  const submitUser = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      setAuthStatus({ type: "success", message: "Registracija je uspešna. Prijavljeni ste." });
      router.push("/");
    } catch (error: unknown) {
    ...
    <section className="auth-luxe">
      ...
      <div className="auth-luxe-grid">
        <article className="auth-luxe-info">
          <span className="auth-luxe-watermark" aria-hidden="true">
            PRISTUP
          </span>
          ...
          {!isResetMode ? (
            <>
              <div className="auth-luxe-card-head">
                ...
                <div className="auth-luxe-tabs" role="tablist" aria-label="Korisnička autentikacija">
                  ...
                  >
                    <span className="auth-luxe-tab-num" aria-hidden="true">
                      01
                    </span>
                    Prijava
                  </button>
              ...
              <form className="auth-luxe-form" onSubmit={submitUser}>
                ...
                {mode === "signup" ? (
                  <label className="legal-consent-checkbox" htmlFor="register-marketing-consent">
                    ...
                    />
                    <span>Želim da primam promo ponude i novosti studija mejlom.</span>
                  </label>
                ) : null}
            ...
            <div className="auth-luxe-reset-shell">
              ...
              <div className="auth-luxe-help">
                ...
                <p>Ako je link istekao, vratite se na prijavu i izaberite opciju &quot;Zaboravljena šifra&quot;.</p>
              </div>
            </div>
          )}
        </article>
