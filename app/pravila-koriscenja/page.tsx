...
export const metadata: Metadata = buildPageMetadata({
  ...
  description: "Uslovi korišćenja sajta Studio Lady Gaga, pravila online kupovine, porudžbina i korišćenja sadržaja.",
  path: "/pravila-koriscenja",
  keywords: ["pravila korišćenja", "uslovi kupovine", "online kupovina proizvoda za kosu", "Studio Lady Gaga uslovi"],
});
    ...
    >
      ...
      <section className="legal-doc-section">
        ...
        <ul className="legal-list">
          <li>Fotografije imaju informativni karakter i mogu da odstupaju od stvarnog izgleda proizvoda.</li>
          <li>Cene su izražene u RSD i mogu da budu promenjene pre finalne potvrde porudžbine.</li>
          <li>Status zaliha se ažurira automatski i može da kasni u realnom vremenu.</li>
        </ul>
      </section>
      ...
      <section className="legal-doc-section">
        ...
        <ul className="legal-list">
          <li>Porudžbina je validna tek nakon uspešnog evidentiranja u sistemu.</li>
          <li>
          ...
          <li>Studio može da odbije porudžbinu kod sumnje na zloupotrebu, lažne podatke ili automatizovano naručivanje.</li>
        </ul>
      </section>
      ...
      <section className="legal-doc-section">
        ...
        <p>
          Pravila mogu da se menjaju radi usklađivanja sa poslovnim, tehničkim ili zakonskim zahtevima. Nova verzija
