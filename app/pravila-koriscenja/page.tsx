  ...
  return (
    ...
    >
      <section className="legal-doc-section">
        ...
        <p>
          Ako se ne slazete sa pravilima, potrebno je da prekinete korišćenje sajta i da ne nastavite sa slanjem
      ...
      <section className="legal-doc-section">
        ...
        <ul className="legal-list">
          ...
          <li>Cene su izrazene u RSD i mogu biti promenjene pre finalne potvrde narudžbine.</li>
          <li>Status zaliha se azurira automatski i može kasniti u realnom vremenu.</li>
        </ul>
      </section>

      <section className="legal-doc-section">
        <h2>3. Narucivanje i obrada porudžbine</h2>
        <p>
          Slanjem forme za placanje korisnik potvrđuje da su uneti podaci tacni i da ima pravo da koristi dostavljene
          kontakt informacije.
        </p>
        <ul className="legal-list">
          <li>Narudžbina je validna tek nakon uspesnog evidentiranja u sistemu.</li>
          <li>
            U slucaju ocigledne greske u ceni, dostupnosti ili tehnickog problema, zadrzavamo pravo korekcije ili
            otkazivanja porudžbine uz obavestenje korisniku.
          </li>
          <li>Studio može odbiti porudžbinu kod sumnje na zloupotrebu, lazne podatke ili automatizovano narucivanje.</li>
        </ul>
      </section>
      ...
      <section className="legal-doc-section">
        ...
        <ul className="legal-list">
          <li>Korišćenje sajta iskljucivo u zakonite svrhe.</li>
      ...
      <section className="legal-doc-section">
        ...
        <p>
          ...
          gresaka, ali aktivno održavamo sistem i bezbednost.
        </p>
        <p>
      ...
      <section className="legal-doc-section">
        ...
        <p>
          Pravila se mogu menjati radi usklađivanja sa poslovnim, tehnickim ili zakonskim zahtevima. Nova verzija
