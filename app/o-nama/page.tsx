    ...
    <div className="about-editorial">
      <section className="about-hero">
        <div className="about-hero-inner">
          ...
          <h1 className="about-hero-title">Prostor gde se lepota neguje kroz znanje, preciznost i sigurnost.</h1>
        ...
        <div className="about-founder-inner">
          <div className="about-founder-text">
            <div className="about-glass-card about-founder-card">
              ...
              <h2 className="about-section-title">Svaka klijentkinja dobija plan koji odgovara baš njenoj kosi.</h2>
              ...
              <blockquote className="about-quote">
                Lepota je više od izgleda. To je samopouzdanje koje nosite sa sobom.
              </blockquote>
            </div>
          </div>
      ...
      <section className="about-services">
        <div className="about-services-inner">
          <div className="about-glass-card about-services-card">
            ...
            <h2 className="about-section-title">Tretmani kose, koloracije, keratin i frizure.</h2>
      ...
      <section className="about-treatments">
        <div className="about-treatments-inner">
          <div className="about-treatments-header">
            ...
            <h2 className="about-section-title">Profesionalni tretmani koje kombinujemo prema realnom stanju vlasi.</h2>
          </div>
      ...
      <section className="about-gallery">
        <div className="about-gallery-inner">
          ...
          <h2 className="about-section-title">Detalji rada kroz fotografije iz studija.</h2>
      ...
      <section className="about-cta">
        <div className="about-glass-card about-cta-card">
          <p className="about-tag">Dobro došli</p>
          <h2 className="about-cta-title">Ovde se neguju kvalitet, sigurnost i transformacija.</h2>
          <p className="about-cta-text">
            Ako želite da osvežite boju, oporavite kosu ili pripremite novu frizuru, pošaljite poruku i dobićete jasan
            plan rada.
          </p>
          <div className="about-hero-actions">
            <Link href="/kontakt" className="about-btn-primary">
