...
import { RevealShowcase } from "@/components/reveal-showcase";
      ...
      <section className="home-panel home-reveal xeno-hero" aria-labelledby="home-hero-heading">
        ...
        <div className="xeno-hero-portrait">
          <Image
            ...
            alt="Dragana, osnivač i profesionalni frizer u salonu Studio Lady Gaga Šabac"
            width={880}
            height={1100}
        ...
        <div className="xeno-hero-header">
          <figure className="xeno-hero-portrait-mobile">
            <Image
              src="/slike/gaga/gaga.avif"
              alt="Dragana, osnivač i profesionalni frizer u salonu Studio Lady Gaga Šabac"
              width={400}
          ...
          <p className="xeno-hero-subtitle xeno-hero-subtitle-secondary">
            U studiju Lady Gaga No. 1 svaka klijentkinja dobija individualni pristup, profesionalne tretmane i rezultat koji spaja zdravu kosu i prefinjenu estetiku.
          </p>
        </div>
        ...
        <div className="xeno-main-column">
          ...
          <section style={{ display: 'flex', flexDirection: 'column' }} className="home-panel home-reveal xeno-final-cta">
            <div>
              ...
              <h2>Pošaljite inspiraciju, a mi pripremamo jasan plan tretmana i preporuku proizvoda.</h2>
              <p>
