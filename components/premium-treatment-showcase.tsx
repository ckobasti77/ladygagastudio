...
import { ArrowRight, Camera, Clock3, Droplets, Eye, Feather, ShieldCheck, Sparkles } from "lucide-react";
...
const GLAM_PRIMARY_IMAGE_POSITIONS = [
  "object-[50%_48%]",
  "object-[50%_18%]",
  "object-[50%_13%]",
  "object-[52%_26%]",
        ...
        <div className="mx-auto max-w-[72rem] space-y-6 sm:space-y-8">
          ...
          <div className="grid gap-5 lg:grid-cols-[minmax(0,0.33fr)_minmax(0,0.67fr)] lg:items-start">
            ...
            <div className="grid grid-cols-2 gap-4 lg:grid-cols-4">
              {GLAM_GALLERY.slice(0, 4).map((image, index) => (
                <div
                  key={image.src}
                  className="h-[8rem] sm:h-[18rem] lg:h-[20rem] overflow-hidden rounded-[1.75rem] border border-[#ead8cc] bg-white/75 shadow-[0_24px_60px_-42px_rgba(63,34,21,0.32)] dark:border-[#4a342c] dark:bg-[#201412] dark:shadow-[0_24px_60px_-42px_rgba(0,0,0,0.74)]"
                >
                  <Image
                    src={image.src}
                    alt={image.alt}
                    ...
                    className={`h-full w-full object-cover ${GLAM_PRIMARY_IMAGE_POSITIONS[index]}`}
                  />
                </div>
              ))}
            </div>
          ...
          <div className="grid gap-4 lg:grid-cols-[minmax(0,0.82fr)_minmax(0,1.18fr)] lg:items-stretch">
              <div className="min-h-[8.5rem] overflow-hidden rounded-[2rem] border border-[#ead8cc] bg-white/75 shadow-[0_24px_62px_-42px_rgba(63,34,21,0.32)] dark:border-[#4a342c] dark:bg-[#201412] dark:shadow-[0_24px_62px_-42px_rgba(0,0,0,0.74)] sm:min-h-[9.5rem] lg:min-h-[16rem] lg:h-full">
                <Image
              ...
              <div className="flex min-h-0 flex-col gap-4 lg:h-full">
                <div className="flex flex-col items-center justify-center gap-3 rounded-[1.6rem] border border-[#ead8cc] bg-white/58 px-4 py-4 text-center shadow-[0_20px_44px_-34px_rgba(83,46,27,0.18)] dark:border-[#4a342c] dark:bg-white/[0.05] dark:shadow-[0_22px_48px_-36px_rgba(0,0,0,0.5)] lg:min-h-[5rem] lg:shrink-0">
                  <ThemeCtaLink
                    href="/kontakt"
                    ...
                    darkClassName={darkCtaClassName}
                  />
                  <p className="max-w-[28rem] text-sm font-medium text-[#7a6155] dark:text-[#e4d0c6]">
                    {GLAM_BENEFITS[0]}
                  </p>
                </div>

                <div className="relative min-h-[8.5rem] overflow-hidden rounded-[2rem] border border-[#ead8cc] bg-white/75 shadow-[0_26px_68px_-42px_rgba(60,31,18,0.34)] dark:border-[#4a342c] dark:bg-[#201412] dark:shadow-[0_26px_68px_-42px_rgba(0,0,0,0.78)] sm:min-h-[9.5rem] lg:min-h-[11.5rem] lg:flex-1">
                  <Image
